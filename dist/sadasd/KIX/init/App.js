...
exports.App = {
    ...
    __args: __args,
    __Dev_Mode: !!((_a = __args._) === null || _a === void 0 ? void 0 : _a.includes("start")),
    __Host,
    ...
    init() {
        ...
        if (runBuild || runStart) {
            if (runStart) {
                if (!this.__kixModuleLocation && !((_a = this.__kixModuleLocation) === null || _a === void 0 ? void 0 : _a.includes(this.__RunDirName))) {
