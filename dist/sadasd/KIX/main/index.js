...
exports.NodeMethods = {
    svg(objectNode, nodeName, createElement, createKixElement) {
        const newNode = Object.assign({}, objectNode), element = createSvgElement("svg");
        delete newNode.svg;
    ...
    switch(switchObjectNode, nodeName, createElement, createKixElement) {
        let newSwitchObjectNode = Object.assign({}, switchObjectNode);
    ...
    routerBlock(routeObjectNode) {
        let tagName = routeObjectNode.tagName || "div", ifemptycomponent = routeObjectNode.ifemptycomponent || "", routerBlock = routeObjectNode.routerBlock, fakeNode = kix(null, ""), existNode = fakeNode, newRouteObjectNode = Object.assign({ [tagName]: [fakeNode, routerBlock] }, routeObjectNode);
